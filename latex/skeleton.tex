...
knowledge for our research into event extraction. This argumentation representation consists of robusts,
...
\begin{tabular}{|c|c|c|c|c|c|c|}
  \hline
  Accuracy  & DT (triple) & SVM & LR & Perceptron & MLP & Baseline\\
  \hline
  With Articles & 48\%    & nan\% &  nan\% & nan\% & nan\% & 50\%\\
\hline
With Titles & nan\% & 36\%    & nan\% & nan\% & nan\% & 50\%\\
\hline
\multicolumn{3}{@{}p{1.5in}}{\footnotesize DT $=$ Decision Tree}\\
\multicolumn{3}{@{}p{1.5in}}{\footnotesize LR $=$ Logistic Regression}\\
