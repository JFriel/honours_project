...
\section{Wikipedia As a Data Source}%%Potential Chapter name change
...
For example using the OLLIE system proved better then the ReVerb system, however neither system provided ideal results in all instances.%Need more here
...
\begin{figure}
  ...
  \caption{An Example one hidden layer MLP \cite{}}%http://scikit-learn.org/stable/modules/neural_networks_supervised.html
  \label{fig:mlp}
\end{figure}
